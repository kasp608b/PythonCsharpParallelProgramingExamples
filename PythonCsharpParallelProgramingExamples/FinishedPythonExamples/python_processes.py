...
#Example of Processes in Python
import threading
import time
import colorama
...
if __name__ == '__main__':
    task1 = Process(target=task, args=(1, 3))
    task2 = Process(target=task, args=(2, 3))
    task3 = Process(target=task, args=(3, 4))
    task4 = Process(target=task, args=(4, 5))
    # Total 150 seconds
